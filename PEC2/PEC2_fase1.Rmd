...
Previamente, al hacer la búsqueda de prueba en la página de PubMed ya habíamos visto que se recuperan más de 26 000 registros. Lo que significa que el tiempo de descarga es relativamente largo y, al haber especificado que se generaría un archivo por cada 5 000 registros, tendremos como resultado 6 archivos de texto conteniendo todos los registros:
